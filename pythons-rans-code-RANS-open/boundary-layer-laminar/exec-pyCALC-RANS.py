...
def modify_u(su2d,sp2d):
   ...
   #print('u2d[-1,3],u2d_face_w[-1,3]',u2d[-1,3],u2d_face_w[-1,3])
   #print('v2d[-1,3],v2d_face_w[-1,3]',v2d[-1,3],v2d_face_w[-1,3])
   #print('p2d[-1,3],p2d_face_w[-1,3]',p2d[-1,3],p2d_face_w[-1,3])
   print('convw[-1,3],u2d_face_w[-1,3]*areaw[-1,3]',convw[-1,3],u2d_face_w[-1,3]*areaw[-1,3])
