...
# set inlet field in entre domain
   u2d=np.repeat(u_rans[None,:], repeats=ni, axis=0)
   k2d=np.repeat(k_rans[None,:], repeats=ni, axis=0)
   om2d=np.repeat(om_rans[None,:], repeats=ni, axis=0)
...
def modify_inlet():
   ...
   global y_rans,y_rans,u_rans,k_rans,om_rans,uv_rans,k_bc_west,eps_bc_west,om_bc_west
