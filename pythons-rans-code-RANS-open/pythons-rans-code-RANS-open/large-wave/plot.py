...
ustar2d=(viscos*abs(u2d[:,0])/dist)**0.5
yplus2d=np.zeros((ni,nj))
for i in range(0,ni):
  yplus2d[i,:]=yp2d[i,:]*ustar2d[i]/viscos

cf=ustar2d**2*np.sign(u2d[:,0])/0.5/u2d[:,-1]**2
...
plt.ylabel(r"$\delta^*$")
plt.xlabel("$x$")
plt.axis([xp2d[0,0],xp2d[-1,0],0,0.35])
...
plt.ylabel(r"$\beta$")
plt.xlabel("$x$")
plt.axis([xp2d[0,0],xp2d[-1,0],-150,50])
...
plt.ylabel(r"$P^+$")
plt.xlabel("$x$")
plt.axis([xp2d[0,0],xp2d[-1,0],-7,0.23])
...
plt.ylabel("$C_f$")
plt.xlabel("$x$")
plt.axis([xp2d[0,0],xp2d[-1,0],-0.0015,0.009])
...
xx=3;
i1 = (np.abs(xx-xp2d[:,1])).argmin()  # find index which closest fits xx
plt.plot(yp2d[i1,:],u2d[i1,:],'g-',label="$x=$"+str(xx))
...
plt.subplots_adjust(left=0.20,bottom=0.20)
i1=0
plt.plot(yp2d[i1,:],v2d[i1,:],'b-',label="inlet")
xx=1;
i1 = (np.abs(xx-xp2d[:,1])).argmin()  # find index which closest fits xx
plt.plot(yp2d[i1,:],v2d[i1,:],'r-',label="$x=$"+str(xx))
xx=2;
i1 = (np.abs(xx-xp2d[:,1])).argmin()  # find index which closest fits xx
plt.plot(yp2d[i1,:],v2d[i1,:],'k-',label="$x=$"+str(xx))
xx=3;
i1 = (np.abs(xx-xp2d[:,1])).argmin()  # find index which closest fits xx
plt.plot(yp2d[i1,:],v2d[i1,:],'g-',label="$x=$"+str(xx))
plt.legend(loc='best',prop=dict(size=13))
plt.ylabel("$V$")
plt.xlabel("$y$")
plt.axis([0, 1, -2, 2])
...
xx=3;
i1 = (np.abs(xx-xp2d[:,1])).argmin()  # find index which closest fits xx
plt.plot(yp2d[i1,:],vis2d[i1,:]/viscos,'g-',label="$x=$"+str(xx))
plt.legend(loc='best',prop=dict(size=13))
plt.ylabel(r"$\nu_t/\nu$")
plt.xlabel("$y$")
plt.axis([0, 1.3, 0,1100])
...
plt.subplots_adjust(left=0.20,bottom=0.20)
i1 = 0
plt.plot(yp2d[i1,:],k2d[i1,:],'b-',label="inlet")
xx=1;
i1 = (np.abs(xx-xp2d[:,1])).argmin()  # find index which closest fits xx
plt.plot(yp2d[i1,:],k2d[i1,:],'r-',label="$x=$"+str(xx))
xx=2;
i1 = (np.abs(xx-xp2d[:,1])).argmin()  # find index which closest fits xx
plt.plot(yp2d[i1,:],k2d[i1,:],'k-',label="$x=$"+str(xx))
xx=3;
i1 = (np.abs(xx-xp2d[:,1])).argmin()  # find index which closest fits xx
plt.plot(yp2d[i1,:],k2d[i1,:],'g-',label="$x=$"+str(xx))
plt.legend(loc='best',prop=dict(size=13))
plt.ylabel("$k$")
plt.xlabel("$y$")
plt.axis([0, 1.3, 0, 40])
...
plt.subplots_adjust(left=0.20,bottom=0.20)
i1 = 0
plt.plot(yp2d[i1,:],om2d[i1,:],'b-',label="inlet")
xx=1;
i1 = (np.abs(xx-xp2d[:,1])).argmin()  # find index which closest fits xx
plt.plot(yp2d[i1,:],om2d[i1,:],'r-',label="$x=$"+str(xx))
xx=2;
i1 = (np.abs(xx-xp2d[:,1])).argmin()  # find index which closest fits xx
plt.plot(yp2d[i1,:],om2d[i1,:],'k-',label="$x=$"+str(xx))
xx=3;
i1 = (np.abs(xx-xp2d[:,1])).argmin()  # find index which closest fits xx
plt.plot(yp2d[i1,:],om2d[i1,:],'g-',label="$x=$"+str(xx))
plt.legend(loc='best',prop=dict(size=13))
plt.ylabel(r"$\omega$")
plt.xlabel("$y$")
plt.axis([0, 1.3, 0, 3000])
plt.savefig('om.png',bbox_inches='tight')
...
fig1,ax1 = plt.subplots()
plt.subplots_adjust(left=0.25,bottom=0.20)
plt.plot(x2d[::5,0],y2d[::5,0],'b-')

plt.plot(x2d[::5,-1],y2d[::5,-1],'b-')

plt.plot(x2d[0,::5],y2d[0,::5],'b-')

plt.plot(x2d[-1,::5],y2d[-1,::5],'b-')
plt.axis('equal')

plt.ylabel("$y$")
plt.xlabel("$x$")
plt.savefig('grid-contour-hill.png',bbox_inches='tight')
